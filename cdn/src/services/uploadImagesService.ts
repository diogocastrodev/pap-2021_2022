...
function fileFilter (req: Request, file: Express.Multer.File, cb: FileFilterCallback) {
    ...
    if(
        ...
        cb(null, false);
        console.log(`✨ Images ✨ Attempt to upload the file: ${file.originalname}.${file.mimetype.split(`/`)[1].toLowerCase()} (${file.size}) failed`);
    }
  
  }

  
  export const pathName = "images/products/";
